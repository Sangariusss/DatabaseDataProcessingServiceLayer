package main.java.com.sangarius.dataprocessingwithdao.service;
...
import main.java.com.sangarius.dataprocessingwithdao.dao.exceptions.ValidationException;
...
import main.java.com.sangarius.dataprocessingwithdao.service.validation.AnimalValidationService;
import main.java.com.sangarius.dataprocessingwithdao.service.validation.EmployeeValidationService;
import main.java.com.sangarius.dataprocessingwithdao.service.validation.EnclosureValidationService;
import main.java.com.sangarius.dataprocessingwithdao.service.validation.VisitorValidationService;
...
public class DatabaseService {
    ...
    public void addAnimal(UUID id, String name, String species, int age, int enclosureId) {
        AnimalValidationService validator = new AnimalValidationService()
            .name(name)
            .species(species)
            .age(age)
    ...
    public void addEmployee(UUID id, String name, String position, double salary) {
        EmployeeValidationService validator = new EmployeeValidationService()
            .name(name)
            .position(position)
            .salary(salary);
        List<String> validationErrors = validator.validate();
    ...
    public void addEnclosure(UUID id, String name, String type, int capacity) {
        EnclosureValidationService validator = new EnclosureValidationService()
            .name(name)
            .type(type)
            .capacity(capacity);
        List<String> validationErrors = validator.validate();
    ...
    public void addVisitor(UUID id, String name, int age) {
        VisitorValidationService validator = new VisitorValidationService()
            .name(name)
            .age(age);
        List<String> validationErrors = validator.validate();
        if (!validationErrors.isEmpty()) {
